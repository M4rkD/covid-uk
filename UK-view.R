...
# load data
covid_output_path = file.path(covid_uk_path, "output");
d1 =   reflow_dynamics(qread(file.path(covid_output_path, "1-dynamics.qs")));
t1 =     reflow_totals(qread(file.path(covid_output_path, "1-totals.qs")));
d2.1 = reflow_dynamics(qread(file.path(covid_output_path, "2.1-dynamics.qs")));
t2.1 =   reflow_totals(qread(file.path(covid_output_path, "2.1-totals.qs")));
d2.2 = reflow_dynamics(qread(file.path(covid_output_path, "2.2-dynamics.qs")));
t2.2 =   reflow_totals(qread(file.path(covid_output_path, "2.2-totals.qs")));
d3 =   reflow_dynamics(qread(file.path(covid_output_path, "3-dynamics.qs")));
t3 =     reflow_totals(qread(file.path(covid_output_path, "3-totals.qs")));
d4 =   reflow_dynamics(qread(file.path(covid_output_path, "4-dynamics.qs")));
t4 =     reflow_totals(qread(file.path(covid_output_path, "4-totals.qs")));
d6 =   reflow_dynamics(qread(file.path(covid_output_path, "6-dynamics.qs")));
t6 =     reflow_totals(qread(file.path(covid_output_path, "6-totals.qs")));
r0s =                  qread(file.path(covid_output_path, "5-dynamics.qs"));

# ANALYSIS 1 - 12 WEEK INTERVENTIONS
tb1 = make_table(d1)
pl1 = plot_table(tb1)
save_table(tb1, file.path(covid_uk_path, "table-12week.csv"));
...
tb4 = make_table(d4)
pl1 = plot_table(tb4)
save_table(tb4, file.path(covid_uk_path, "table-grandparents.csv"));
...
tb6 = make_table(d6)
pl1 = plot_table(tb6)
save_table(tb6, file.path(covid_uk_path, "table-sports.csv"));
